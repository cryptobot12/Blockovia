...
SOURCES += src/activemasternode.cpp \
           ...
           src/privatesend.cpp \
           src/blockovia-cli.cpp \
           src/blockovia-tx.cpp \
           src/blockovia.cpp \
           src/db.cpp \
           ...
           src/qt/blockovia.cpp \
           src/qt/blockoviastrings.cpp \
...
RESOURCES += src/qt/blockovia.qrc src/qt/blockovia_locale.qrc

TRANSLATIONS += src/qt/locale/blockovia_bg.ts \
                src/qt/locale/blockovia_de.ts \
                src/qt/locale/blockovia_en.ts \
                src/qt/locale/blockovia_es.ts \
                src/qt/locale/blockovia_fi.ts \
                src/qt/locale/blockovia_fr.ts \
                src/qt/locale/blockovia_it.ts \
                src/qt/locale/blockovia_ja.ts \
                src/qt/locale/blockovia_pl.ts \
                src/qt/locale/blockovia_pt.ts \
                src/qt/locale/blockovia_ru.ts \
                src/qt/locale/blockovia_sk.ts \
                src/qt/locale/blockovia_sv.ts \
                src/qt/locale/blockovia_vi.ts \
                src/qt/locale/blockovia_zh_CN.ts \
                src/qt/locale/blockovia_zh_TW.ts
