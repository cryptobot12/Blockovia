...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop blockovia server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "blockovia server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* blockovia features */
        {"blockovia", "masternode", &masternode, true, true, false},
        {"blockovia", "listmasternodes", &listmasternodes, true, true, false},
        {"blockovia", "getmasternodecount", &getmasternodecount, true, true, false},
        {"blockovia", "masternodeconnect", &masternodeconnect, true, true, false},
        {"blockovia", "masternodecurrent", &masternodecurrent, true, true, false},
        {"blockovia", "masternodedebug", &masternodedebug, true, true, false},
        {"blockovia", "startmasternode", &startmasternode, true, true, false},
        {"blockovia", "createmasternodekey", &createmasternodekey, true, true, false},
        {"blockovia", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"blockovia", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"blockovia", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"blockovia", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"blockovia", "getmasternodescores", &getmasternodescores, true, true, false},
        {"blockovia", "mnbudget", &mnbudget, true, true, false},
        {"blockovia", "preparebudget", &preparebudget, true, true, false},
        {"blockovia", "submitbudget", &submitbudget, true, true, false},
        {"blockovia", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"blockovia", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"blockovia", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"blockovia", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"blockovia", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"blockovia", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"blockovia", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"blockovia", "checkbudgets", &checkbudgets, true, true, false},
        {"blockovia", "mnsync", &mnsync, true, true, false},
        {"blockovia", "spork", &spork, true, true, false},
        {"blockovia", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"blockovia", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use blockoviad, or the -server option to blockovia-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"blockovia Alert\" admin@foo.com\n"),
...
{
    return "> blockovia-cli " + methodname + " " + args + "\n";
}
