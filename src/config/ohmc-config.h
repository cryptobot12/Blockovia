/* src/config/blockovia-config.h.  Generated from blockovia-config.h.in by configure.  */
/* src/config/blockovia-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.blockovia.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "blockovia Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "blockovia Core 2.3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "blockovia"
