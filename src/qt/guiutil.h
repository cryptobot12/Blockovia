...
/** Utility functions used by the BCK Qt UI.
 */
namespace GUIUtil
{
...
// Render BCK addresses in monospace font
...
// Parse "blockovia:" URI into recipient object, return true on successful parsing
