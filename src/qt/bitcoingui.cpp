                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BCK Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BCK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and blockovia: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BCK Core"), this);
    aboutAction->setStatusTip(tr("Show information about BCK Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BCK"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BCK addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BCK addresses"));
    ...
    openAction->setStatusTip(tr("Open a BCK: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BCK Core help message to get a list with possible BCK command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BCK Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BCK network", "", count));
}
...
{
    QString strTitle = tr("BCK Core"); // default title
