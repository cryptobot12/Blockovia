...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("blockovia Core blockovia-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  blockovia-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded blockovia transaction") + "\n" +
                               "  blockovia-tx [options] -create [commands]   " + _("Create hex-encoded blockovia transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded blockovia transaction
