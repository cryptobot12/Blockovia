Contributing to BCK Core
============================

The BCK Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BCK Core project, and is not to be
confused with overall BCK Network Protocol consensus changes.

Whether a pull request is merged into BCK Core rests with the project merge
...
Patches that change BCK consensus rules are considerably more involved than
...
Where a patch set proposes to change the BCK consensus, it must have been
...
The project leader is the release manager for each BCK Core release.
