...
This mechanism has been integrated into Bitcore-Node-BCK which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BCK-Project/insight-api-blockovia#web-socket-api](https://github.com/BCK-Project/insight-api-blockovia#web-socket-api) 
* API: [https://github.com/BCK-Project/insight-api-blockovia#swifttx-transactions](https://github.com/BCK-Project/insight-api-blockovia#swifttx-transactions) 
...
By default, the BCK Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BCK Core daemon:
