...
In order to support loading of multiple wallets in blockovia-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is blockovia.cpp.
...
Changes to blockovia.cpp
----------------------
blockovia.cpp is the entry point into blockovia-qt, and as such, will require some minor modifications to provide hooks for
